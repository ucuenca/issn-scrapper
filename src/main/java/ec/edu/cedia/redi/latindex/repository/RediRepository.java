...
public class RediRepository implements AutoCloseable {
    ...
    public final static String ENDPOINT_REDI = "http://201.159.222.25:8180/repositories/data";
    private final static String QUERY_ENDPOINT_REDI = ENDPOINT_REDI ;
    private final static String UPDATE_ENDPOINT_REDI = ENDPOINT_REDI + "/statements";
